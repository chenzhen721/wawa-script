...
class SensorsApi {
    ...
    */
    static final Long BEGIN = 1402565400000L // 2014-06-12 17:30:00 == 1402565400000L
    static final Long END = yesterDayZeroMilliSecond() // 获取今天的00:00:00
     ...
     * @return
     */
    static Long yesterDayZeroMilliSecond(){
        Calendar now = Calendar.getInstance()
        now.setTime(new Date());
        now.set(Calendar.HOUR_OF_DAY, 0)
        now.set(Calendar.MINUTE, 0)
