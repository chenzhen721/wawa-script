...
//            def id = obj['_id'] as String
//            def current_count = obj['count'] as Long
//            def current_coin = obj['cost'] as Long
//            total_count += current_count
//            total_coin += current_coin
//            detail.put(id, obj)
//        }
//
//        def _id = YMD + '_send_gift'
//        def row = ['timestamp': yesTday, '_id': _id, 'total_count': total_count, 'total_coin': total_coin, 'detail': detail]
//        def coll = mongo.getDB('xy_admin').getCollection('stat_gift')
//        coll.save($$(row))
//    }
//
//
...
//                timestamp: begin
//        )
//        def coll = mongo.getDB('xy_admin').getCollection('stat_login')
//        coll.save(obj)
...
//        def list = mongo.getDB('xy_admin').getCollection('finance_log').find(new BasicDBObject(timestamp: [$gte: yesTday, $lt: zeroMill])).toArray()
//        def total = new BigDecimal(0)
//        def totalCoin = new AtomicLong()
//        def pays = MapWithDefault.<String, PayType> newInstance(new HashMap()) {
//            new PayType()
//            list.each { obj ->
...
//            def coll = mongo.getDB('xy_admin').getCollection('stat_finance')
//            coll.save(obj)
//        }
//    }
//
...
//            def _id = obj['_id'] as Integer
//            def current_count = obj['count'] as Integer
//            def current_coin = obj['cost'] as Long
//            total_coin += current_coin
//            total_count += current_count
//            map.put(_id.toString(), obj)
//        }
//
//        def coll = mongo.getDB('xy_admin').getCollection('stat_week_star')
//        def _id = YMD + '_week_star'
//        def row = ['timestamp': gteMill, '_id': _id, 'total_count': total_count, 'total_coin': total_coin, 'detail': map]
//        coll.save($$(row))
//    }
//
//    /**
...
//                timestamp  : yesTday
//        ])
//        def coll = mongo.getDB('xy_admin').getCollection('stat_allcost')
//        coll.save($$(cost))
//    }
//
//
//    private static Map dayCost() {
...
//    def coll = mongo.getDB('xy_admin').getCollection('stat_mission')
//    def begin = yesTday - i * DAY_MILLON
//    def YMD = new Date(begin).format('yyyyMMdd_')
//    def timebetween = [$gte: begin, $lt: begin + DAY_MILLON]
...
//    row.type = "game"
//    def coll = mongo.getDB('xy_admin').getCollection('stat_game')
//    coll.save(row)
//}
//
